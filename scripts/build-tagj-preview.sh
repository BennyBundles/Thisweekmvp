...
cp index.html preview.html full.html tagj.html artist.html producer.html creative.html contact.html licensing.html 404.html .tagj-dist/
...
printf 'V15.22' > .tagj-dist/VERSION.txt
