...
rm -rf .tagj-dist
mkdir -p .tagj-dist/tagj-assets/v147 .tagj-dist/tagj-assets/intro .tagj-dist/tagj-assets/network .tagj-dist/tagj-data .tagj-dist/legal
...
printf 'V15.11' > .tagj-dist/VERSION.txt
