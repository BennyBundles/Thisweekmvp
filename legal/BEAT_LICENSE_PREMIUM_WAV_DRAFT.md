...
## 1. Grant
Licensor grants Licensee a **non-exclusive, non-transferable commercial license for 5 years** to use the Beat in one New Song. Licensor may continue licensing the Beat to others.
...
## 2. Files Delivered
MP3 plus a genuine lossless WAV master **only when a genuine lossless source exists**. A WAV decoded from an MP3 may be supplied as a convenience derivative if clearly labeled, but it is not represented as a lossless master.
...
- Up to **250,000** monetized audio streams.
- Up to **10,000** paid downloads/physical units.
- **1** monetized music video, up to **250,000** views.
- Up to **50** paid live performances.
- Broadcast on up to **5 terrestrial radio stations**.
...
## 19. Expiration
After 5 years, continued new exploitation requires renewal or upgrade.
