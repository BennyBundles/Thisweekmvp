# TAGJ Trackout Pro Beat License — Non-Exclusive
...
## 1. Grant
Licensor grants Licensee a **non-exclusive, non-transferable commercial license for 7 years** to use the Beat in one New Song. Licensor may continue licensing the Beat to others.
...
## 2. Files Delivered
MP3, a genuine lossless WAV when a genuine lossless source exists, and the **original DAW stems/trackouts** actually listed for the Beat. **This tier may not be represented as an original Trackout Pro license until those original multitracks exist.** A stereo-master-derived separation pack may be delivered only if Schedule A expressly labels it **Derived Mix-Control Stems** and the Licensee accepts that it is not original DAW trackout material.
...
- Up to **1,000,000** monetized audio streams.
- Up to **50,000** paid downloads/physical units.
- Up to **2** monetized music videos, with **1,000,000 combined views**.
- Up to **100** paid live performances.
- Broadcast on up to **10 terrestrial radio stations**.
- No third-party commercial sync.
...
Content ID, Rights Manager, fingerprinting, or similar ownership-claim systems are **not permitted without prior written consent**.
