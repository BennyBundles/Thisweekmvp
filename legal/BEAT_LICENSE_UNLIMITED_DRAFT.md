# TAGJ Unlimited Beat License — Non-Exclusive
...
## 1. Grant
Licensor grants Licensee a **perpetual, non-exclusive, non-transferable commercial license** to use the Beat in one New Song. Licensor may continue licensing the Beat to other parties.
...
## 2. Files Delivered
MP3 and a genuine lossless WAV only when a genuine lossless source exists. A WAV decoded from an MP3 may be supplied as a clearly labeled convenience derivative but is not a lossless master. Original stems/trackouts are included only if the Beat-specific Schedule A expressly lists them. Derived separation stems must be separately labeled as derived.
...
- Third-party commercial sync remains separately licensed.
...
Because this license remains non-exclusive, Content ID, Rights Manager, fingerprinting, or similar ownership-claim systems are **not permitted without prior written consent**.
...
## 19. Unlimited Does Not Mean Exclusive
“Unlimited” removes the stated usage caps; it does **not** stop Licensor from licensing the Beat to other artists and does not transfer ownership of the Beat.
